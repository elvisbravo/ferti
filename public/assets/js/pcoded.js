    ...
    for (
      ...
      o[r].addEventListener("click", function (e) {
        ...
        if (
          ...
          for (
            var o = document.querySelectorAll("li.pc-trigger"), r = 0;
            r < o.length;
            r++
          ) {
            var a = o[r];
    ...
    null !== t &&
      ...
      "horizontal" === t
        ? (document.querySelector(".pc-sidebar").classList.add("d-none"),
          (e.src = "../ferti/public/assets/js/layout-horizontal.js"),
          document.body.appendChild(e))
        : "color-header" === t
        ? document.querySelector(".pc-sidebar .m-header .logo-lg") &&
          document
            .querySelector(".pc-sidebar .m-header .logo-lg")
            .setAttribute("src", "../ferti/public/assets/images/logo-white.svg")
        : "compact" === t
        ? ((e.src = "../ferti/public/assets/js/layout-compact.js"),
          document.body.appendChild(e))
        : "tab" === t &&
          ((e.src = "../ferti/public/assets/js/layout-tab.js"),
          document.body.appendChild(e))),
    null === t &&
...
for (
  ...
  tc[t].setAttribute("src", "../ferti/public/assets/images/logo-white.svg");
var rtl_flag = !1,
  dark_flag = !1;
    ...
    "dark" == e
      ...
      : ((dark_flag = !1),
        document.querySelector(".pc-sidebar .m-header .logo-lg") &&
          document
            .querySelector(".pc-sidebar .m-header .logo-lg")
            .setAttribute("src", "../ferti/public/assets/images/logo-dark.svg"),
        document.querySelector(".navbar-brand .logo-lg") &&
          document
            .querySelector(".navbar-brand .logo-lg")
            .setAttribute("src", "../ferti/public/assets/images/logo-dark.svg"),
